...
generate_bullet_points() {
    ...
    store_meta "$product_id" "_calculated_bullet1" "$bullet1"
    store_meta "$product_id" "_calculated_bullet2" "$bullet2"
    store_meta "$product_id" "_calculated_bullet3" "$bullet3"
    store_meta "$product_id" "_calculated_bullet4" "$bullet4"
    store_meta "$product_id" "_calculated_bullet5" "$bullet5"
}
