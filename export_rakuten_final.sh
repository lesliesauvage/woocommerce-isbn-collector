...
analyze_csv() {
    ...
    # Vérification simple sans caractères problématiques dans echo
...
# Mapper la catégorie WordPress vers Rakuten - MAPPING ICI !
...
echo -n "$rakuten_category;"        # 17 - CATÉGORIE MAPPÉE ICI !
echo -n "$poids;"                   # 18
echo -n "$taille;"                  # 19
echo -n "$pages;"                   # 20
echo -n "$image;"                   # 21
